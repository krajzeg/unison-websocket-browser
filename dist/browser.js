...
UnisonWebSocketClient = require('./index.js');
...
var UnisonWebsocketClient = (function () {
  function UnisonWebsocketClient(websocketUrl) {
    var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

    _classCallCheck(this, UnisonWebsocketClient);

    if (!WebSocket) throw new Error("Your browser does not support websockets.");
  ...
  _createClass(UnisonWebsocketClient, [{
    key: "connect",
  ...
  return UnisonWebsocketClient;
})();

exports["default"] = UnisonWebsocketClient;
